...
  
    ...
    <main class="container mx-auto max-w-screen-xl px-4 py-16">
        <div class="flex flex-col items-center gap-6 mb-10">
            <div class="flex flex-col md:flex-row items-center gap-4 mx-auto max-w-max">
                <div class="flex items-center">
                    <input 
                        type="text" 
                        placeholder="Tìm kiếm phim..."
                        class="w-64 pl-4 pr-2 py-2 border border-r-0 border-gray-300 rounded-l-full bg-white 
                               focus:border-red-500 focus:outline-none focus:ring-0 transition"
                    />
                    <button class="bg-red-600 text-white font-bold py-2 px-4 border border-l-0 border-red-600 rounded-r-full hover:bg-red-700 transition duration-300">
