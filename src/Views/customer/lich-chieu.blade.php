...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-4xl mx-auto mt-6">
        <ul class="flex border-b text-gray-500">
            <li class="mr-6">
                <span class="inline-block py-2 px-4 text-red-600 border-b-2 border-red-600 font-medium">Chọn phim / Rạp
                    / Suất</span>
            </li>
            <li class="mr-6">
    ...
    <div id="step-1" class="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-md mt-10" onsubmit="return checkLogin();">
        ...
        <div class="mb-4">
            ...
            <select id="location"
                class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-red-600">
        ...
        <div class="mb-4">
            ...
            <select id="movie" class="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-red-600">
                ...
                <option value="Mưa Đỏ" data-age="T13" data-img="https://via.placeholder.com/120x180.png?text=Mua+Do">Mưa
                    Đỏ</option>
                <option value="Phim B" data-age="P" data-img="https://via.placeholder.com/120x180.png?text=Phim+B">Phim
                    B</option>
            </select>
        </div>
        ...
        <div class="mb-4 relative">
            ...
            <!-- Nút lùi -->
            <button id="prevDay"
                class="absolute left-0 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-red-500 transition-colors p-2 z-10">
            ...
            <!-- Nút tiến -->
            <button id="nextDay"
                class="absolute right-0 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-red-500 transition-colors p-2 z-10">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
        ...
        <div class="mb-4">
            ...
            <div class="flex flex-wrap gap-2">
                <button data-time="20:15"
                    class="px-4 py-2 border border-red-600 rounded-md text-red-600 hover:bg-red-600 hover:text-white transition">20:15</button>
                <button data-time="20:45"
                    class="px-4 py-2 border border-red-600 rounded-md text-red-600 hover:bg-red-600 hover:text-white transition">20:45</button>
                <button data-time="21:15"
                    class="px-4 py-2 border border-red-600 rounded-md text-red-600 hover:bg-red-600 hover:text-white transition">21:15</button>
                <button data-time="22:00"
                    class="px-4 py-2 border border-red-600 rounded-md text-red-600 hover:bg-red-600 hover:text-white transition">22:00</button>
                <button data-time="22:30"
                    class="px-4 py-2 border border-red-600 rounded-md text-red-600 hover:bg-red-600 hover:text-white transition">22:30</button>
            </div>
        </div>
        ...
        <button
            class="btn-next w-full py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-md transition">Tiếp
            tục</button>
    </div>
    ...
    <div id="step-2" class="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-md mt-10 hidden">
        ...
        <div class="mt-6 flex gap-4">
            <button id="back-step-1"
                class="w-1/2 py-3 border border-gray-400 rounded-md hover:bg-gray-100">Quay lại</button>
            <button
                class="btn-next w-1/2 py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-md transition">Tiếp
                tục</button>
        </div>
    </div>
    ...
    <div id="step-5" class="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-md mt-10 hidden">
        ...
        <div class="mt-6 flex gap-4">
            <button id="back-step-4"
                class="w-1/2 py-3 border border-gray-400 rounded-md hover:bg-gray-100">Quay lại</button>
            <button
                class="w-1/2 py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-md transition">Xác
                nhận</button>
        </div>
    </div>
